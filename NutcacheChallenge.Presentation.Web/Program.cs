using NutcacheChallenge.ClientConnection;
using NutcacheChallenge.ClientConnection.Contract;

namespace NutcacheChallenge.Presentation.Web
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient<INutcacheServiceClient, NutcacheServiceClient>()
